...
# I will insert the Description and Features right after Product Name.
name_regex = r"<div className=\"space-y-1\">\n\s*<label className=\"text-\[10px\] font-extrabold text-slate-400 uppercase\">Product Name \*\w*<\/label>\n\s*<input type=\"text\" required value=\{prodName\} onChange=\{e => setProdName\(e\.target\.value\)\} placeholder=\"e\.g\. Classic Wrist Watch\" className=\"[^\"]*\" \/>\n\s*<\/div>"
...
content = re.sub(name_regex, replacement, content)
